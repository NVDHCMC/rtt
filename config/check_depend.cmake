...
if(OROCOS_TARGET STREQUAL "xenomai")
  ...
  if(XENOMAI_FOUND)
    ...
    list(APPEND OROCOS-RTT_DEFINITIONS "OROCOS_TARGET=${OROCOS_TARGET}") 
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${XENOMAI_CFLAGS} -std=c11 -fPIC")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${XENOMAI_CFLAGS} -std=c++11 -fPIC")
    set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} ${XENOMAI_LDFLAGS} -fPIC")
    set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} ${XENOMAI_LDFLAGS} -fPIC")
